...
async function main() {    
    ...
    if (xpElement !== null) {
        xpElement.textContent = "Made by Aodhan Sterland";
    } 
...
async function credits() {
    await sleep(10000);
    console.clear();
	  console.log.apply(console, ["%c CDN by Aodhan sterland %c ", "color: #000; background: #ffcc33; padding:5px 0;", "color: #fff; background: #242424; padding:5px 0 5px 5px;"]);
